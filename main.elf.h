...
typedef struct TimeKeeper TimeKeeper, *PTimeKeeper;
...
struct TimeKeeper {
    ...
    byte field_0xa;
    byte field_0xb;
    bool isPaused; /* Created by retype action */
};

typedef struct GameSceneLyt GameSceneLyt, *PGameSceneLyt;

typedef struct someLytSubstruct someLytSubstruct, *PsomeLytSubstruct;

struct someLytSubstruct {
    undefined field_0x0;
    undefined field_0x1;
    undefined field_0x2;
    undefined field_0x3;
...
struct GameSceneLyt { /* PlaceHolder Class Structure */
    undefined field_0x0;
    undefined field_0x1;
    undefined field_0x2;
    undefined field_0x3;
    ...
    struct someLytSubstruct lyt; /* Created by retype action */
    ...
    undefined4 field_0x490;
    int pic1[10]; /* Created by retype action */
    int txt1[11]; /* Created by retype action */
    int pan1[20];
